    ...
    for epoch in range(num_epoches):
        for it, target in enumerate(dataloader_train):
            ...
            if it % log_interval == 0 and FLAGS.local_rank == 0:
                ...
                print("epoch=%3d, iter=%5d, img_loss=%.6f, reg_loss=%.6f, lr=%.5f, time=%.1f ms, rem=%s" % 
                    (epoch, it, img_loss_avg, reg_loss_avg, optimizer.param_groups[0]['lr'], iter_dur_avg*1000, util.time_to_text(remaining_time)))
